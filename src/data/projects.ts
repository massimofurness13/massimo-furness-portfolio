...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    title: "MarkMate",
    blurb:
      "AI marking assistant for UK primary teachers. Upload student work, get instant marks, misconceptions, and class-level analytics. Currently running privately.",
    tags: ["Education", "AI"],
    url: "#",
    status: "Private",
    year: "2026",
  ...
  },
  {
    ...
    blurb:
      "End-to-end investing system with custom front-end and back-end. Currently running privately.",
    tags: ["Finance", "Data"],
    url: "#",
    status: "Private",
    year: "2026",
